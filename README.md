...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-30 14:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/fda8f3a7-4b4e-49d1-b05b-ce0167125fe8.git
$ cd fda8f3a7-4b4e-49d1-b05b-ce0167125fe8
```
